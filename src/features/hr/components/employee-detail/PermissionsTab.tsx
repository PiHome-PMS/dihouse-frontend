    ...
    return (
        <FormField label={label}>
            <div className="relative">
                {/* Selected tags */}
                <div
                    className="min-h-[42px] w-full border border-gray-200 rounded-[3px] p-2 flex flex-wrap gap-2 cursor-pointer bg-white"
                    ...
                    <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-[3px] shadow-lg">
                        ...
                        <div className="max-h-[200px] overflow-y-auto">
                            {filteredOptions.map((opt) => (
                                <label
                                    key={opt.id}
                                    className={`flex items-center gap-2 px-3 py-2 hover:bg-gray-50 cursor-pointer ${selected.includes(opt.id) ? 'bg-blue-50' : ''
                                        }`}
                                >
                                    <input
                                        type="checkbox"
