...
interface OtherTabProps {
  ...
  setFormData: (data: Record<string, string | boolean | number | undefined>) => void;
}
      ...
      <Card className="p-4 border-none shadow-sm rounded-[3px]">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <FormField label="Email nội bộ">
            <Input
              type="email"
              value={str(formData.internalEmail)}
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <FormField label="Ngoại ngữ">
            <Input
              value={str(formData.foreignLanguage)}
          ...
          <FormField label="Tin học">
            <Input
              value={str(formData.computerSkill)}
      ...
      <Card className="p-4 border-none shadow-sm rounded-[3px]">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <FormField label="Tình trạng sức khỏe">
            <Input
              value={str(formData.healthStatus)}
          ...
          <div key={dep.id} className="border rounded-lg p-4 mb-4 relative">
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              ...
              <FormField label="MST NPT">
                <Input
                  ...
                  onChange={(e) => {
                    const updated = [...dependents];
                    updated[index].taxCode = e.target.value;
                    setDependents(updated);
                  }}
                  className="h-10 rounded-[3px]"
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              ...
              <FormField label="Nơi cấp">
                <Input
                  value={dep.issuePlace || ''}
                  onChange={(e) => {
                    const updated = [...dependents];
                    updated[index].issuePlace = e.target.value;
                    setDependents(updated);
                  }}
                  className="h-10 rounded-[3px]"
