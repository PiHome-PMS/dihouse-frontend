          ...
          {schedule.map((daySchedule) => {
            ...
            return (
              <div
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleDayClick(daySchedule)}
                tabIndex={hasShifts ? 0 : -1}
                className={`p-2 border border-gray-100 min-h-[70px] text-gray-600 ${
                  isWeekend ? 'bg-gray-50' : hasShifts ? 'cursor-pointer hover:bg-gray-50' : ''
                }`}
              >
