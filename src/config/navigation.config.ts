...
export const navigationConfig: NavItem[] = [
  ...
  },
  {
    ...
    icon: Grid2X2,
    children: [
      { id: 'attendance-config', label: 'Cấu hình chấm công', path: ROUTES.DASHBOARD },
      { id: 'attendance-devices', label: 'Quản lý thiết bị chấm công', path: ROUTES.DASHBOARD },
      { id: 'positions', label: 'Quản lý chức vụ', path: ROUTES.DASHBOARD },
      { id: 'shifts', label: 'Quản lý ca làm việc', path: ROUTES.DASHBOARD },
      { id: 'personnel-list', label: 'Danh sách nhân sự', path: ROUTES.DASHBOARD },
      { id: 'attendance-history', label: 'Lịch sử chấm công', path: ROUTES.DASHBOARD },
      { id: 'attendance-management', label: 'Quản lý chấm công', path: ROUTES.DASHBOARD },
      { id: 'hr-evaluation', label: 'Đánh giá nhân sự tháng', path: ROUTES.DASHBOARD },
    ],
  },
  {
    id: 'setup',
